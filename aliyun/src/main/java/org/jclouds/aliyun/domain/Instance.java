...
//        protected InstanceExtendedAttributes extendedAttributes;
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getUuid()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getTenantId()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getUserId()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getUpdated()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getCreated()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getHostId()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getAccessIPv4()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getAccessIPv6()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getStatus()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getImage()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getFlavor()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getKeyName()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getConfigDrive()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getAddresses()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getMetadata()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getExtendedStatus()
         */
...
//        }
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getExtendedAttributes()
         */
...
//        }
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getDiskConfig()
         */
        ...
        /**
         * @see org.jclouds.aliyun.domain.Instance#getAvailabilityZone()
         */
...
//    private final Optional<InstanceExtendedAttributes> extendedAttributes;
    ...
    protected Instance(String id, @Nullable String name, java.util.Set<Link> links, @Nullable String uuid, String tenantId,
                     ...
                     @Nullable String accessIPv6, Status status, @Nullable Resource image, Resource flavor, @Nullable String keyName,
...
//        this.extendedAttributes = Optional.fromNullable(extendedAttributes);
    ...
    /**
     * @return host identifier, or null if in {@link org.jclouds.aliyun.domain.Instance.Status#BUILD}
     */
    @Nullable
...
//    }
     ...
     * One of {@link org.jclouds.aliyun.domain.Instance#DISK_CONFIG_AUTO} or {@link org.jclouds.aliyun.domain.Instance#DISK_CONFIG_MANUAL}.
     ...
     * originally implmented as a String and {@link org.jclouds.aliyun.domain.Instance#DISK_CONFIG_AUTO} and
     * {@link org.jclouds.aliyun.domain.Instance#DISK_CONFIG_MANUAL} were added later as Strings to preserve backwards
     * compatibility.
     *
     * @see org.jclouds.openstack.nova.v2_0.features.ExtensionApi#getExtensionByAlias
