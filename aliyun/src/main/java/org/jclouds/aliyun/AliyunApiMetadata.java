...
import static org.jclouds.aliyun.config.AliyunProperties.CREDENTIAL_TYPE;

import java.net.URI;
import java.util.Properties;

import org.jclouds.aliyun.config.AliyunAuthenticationModule;
...
/**
 * Implementation of {@link ApiMetadata} for Aliyun API.
 */
   ...
   public static class Builder extends BaseHttpApiMetadata.Builder<AliyunApi, Builder> {
      ...
      protected Builder() {
         id("aliyun")
               ...
               .documentation(URI.create("http://wiki.aliyun.com/display/ABI32/Api+Reference"))
               .defaultEndpoint("http://localhost/api")
               .version("3.2")
               // .view(ComputeServiceContext.class)
               .defaultProperties(AliyunApiMetadata.defaultProperties())
               .defaultModules(
                     ImmutableSet.<Class<? extends Module>> of(AliyunHttpApiModule.class,
                           AliyunAuthenticationModule.class));
      }
