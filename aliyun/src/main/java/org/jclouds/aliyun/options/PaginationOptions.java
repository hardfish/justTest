...
public class PaginationOptions extends BaseHttpRequestOptions {
    ...
    public static class Builder {
        /**
         * @see org.jclouds.aliyun.options.PaginationOptions#queryParameters(com.google.common.collect.Multimap)
         */
        ...
        /**
         * @see org.jclouds.aliyun.options.PaginationOptions#changesSince(java.util.Date)
         * @deprecated The {@code changes-since} query does not apply to all OpenStack APIs. Please refer to the OpenStack
         *             Nova {@code ListOptions.changesSince(Date)} and Glance {@code ListImageOptions.changesSince(Date)}.
         *             To be removed in jclouds 2.0.
         */
        ...
        /**
         * @see org.jclouds.aliyun.options.PaginationOptions#marker(String)
         */
        ...
        /**
         * @see org.jclouds.aliyun.options.PaginationOptions#limit(int)
         */
