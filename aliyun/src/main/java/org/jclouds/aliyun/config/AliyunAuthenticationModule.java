...
/**
 * Configures the Aliyun authentication.
 */
public class AliyunAuthenticationModule extends AbstractModule {
   ...
   // Aliyun authentication tokens have 30 minutes life time
   @Provides
   @Singleton
