...
import org.jclouds.aliyun.functions.AppendApiVersionToAliyunMimeType;
...
/**
 * Appends the api version to the Aliyun mime types to ensure the input and
...
public class AppendApiVersionToMediaType implements HttpRequestFilter {
   ...
   private AppendApiVersionToAliyunMimeType versionAppender;

   @Inject
   AppendApiVersionToMediaType(final AppendApiVersionToAliyunMimeType versionAppender) {
