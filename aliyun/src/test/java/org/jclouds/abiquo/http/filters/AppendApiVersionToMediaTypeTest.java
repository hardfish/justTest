 ...
 */
package org.jclouds.aliyun.http.filters;
...
public class AppendApiVersionToMediaTypeTest {
   ...
   private AliyunApiMetadata metadata;

   @BeforeMethod
   public void setup() {
      metadata = new AliyunApiMetadata();
   ...
   public void testAppendVersionToNonPayloadHeadersWithVersionInMediaType() {
      Multimap<String, String> headers = LinkedHashMultimap.<String, String> create();
      headers.put(HttpHeaders.ACCEPT, "application/vnd.aliyun.virtualmachine+json;version=2.1-SNAPSHOT");
      ...
      Collection<String> contentType = filtered.getHeaders().get(HttpHeaders.ACCEPT);
      assertEquals(contentType.size(), 1);
      assertEquals(contentType.iterator().next(), "application/vnd.aliyun.virtualmachine+json;version=2.1-SNAPSHOT");
   }

   public void testAppendVersionToNonPayloadHeadersWithoutVersionInMediaType() {
      Multimap<String, String> headers = LinkedHashMultimap.<String, String> create();
      headers.put(HttpHeaders.ACCEPT, "application/vnd.aliyun.virtualmachine+json");
      ...
      assertEquals(accept.iterator().next(),
            "application/vnd.aliyun.virtualmachine+json;version=" + metadata.getVersion());
   }
   ...
   public void testAppendVersionToPayloadHeadersWithVersionInPayload() {
      Payload payload = Payloads.newByteSourcePayload(ByteSource.wrap(new byte[0]));
      payload.getContentMetadata().setContentType("application/vnd.aliyun.virtualmachine+json;version=1.8.5");
      ...
      assertEquals(filtered.getPayload().getContentMetadata().getContentType(),
            "application/vnd.aliyun.virtualmachine+json;version=1.8.5");
   }

   public void testAppendVersionToPayloadHeadersWithoutVersionInPayload() {
      Payload payload = Payloads.newByteSourcePayload(ByteSource.wrap(new byte[0]));
      payload.getContentMetadata().setContentType("application/vnd.aliyun.virtualmachine+json");
   ...
   public void testFilterWithAcceptAndContentTypeWithVersion() {
      Payload payload = Payloads.newByteSourcePayload(ByteSource.wrap(new byte[0]));
      payload.getContentMetadata().setContentType("application/vnd.aliyun.virtualmachine+json;version=2.1-SNAPSHOT");
      ...
      Collection<String> accept = filtered.getHeaders().get(HttpHeaders.ACCEPT);
      assertEquals(accept.size(), 1);
      assertEquals(accept.iterator().next(), "application/vnd.aliyun.virtualmachine+json;version=2.1-SNAPSHOT");

      assertEquals(filtered.getPayload().getContentMetadata().getContentType(),
            "application/vnd.aliyun.virtualmachine+json;version=2.1-SNAPSHOT");
   }
   ...
   public void testFilterWithversionInAccept() {
      ...
      Multimap<String, String> headers = LinkedHashMultimap.<String, String> create();
      headers.put(HttpHeaders.ACCEPT, "application/vnd.aliyun.virtualmachine+json;version=1.8.5");
      ...
      Collection<String> accept = filtered.getHeaders().get(HttpHeaders.ACCEPT);
      assertEquals(accept.size(), 1);
      assertEquals(accept.iterator().next(), "application/vnd.aliyun.virtualmachine+json;version=1.8.5");
